...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__22248__auto__,writer__22249__auto__,opt__22250__auto__){
return cljs.core._write.call(null,writer__22249__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__21642__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__21642__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__21642__auto__)){
return or__21642__auto__;
} else {
...
var G__23853 = o;
(G__23853[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__23855__i < G__23855__a.length) {G__23855__a[G__23855__i] = arguments[G__23855__i + 0]; ++G__23855__i;}
  args = new cljs.core.IndexedSeq(G__23855__a,0);
} 
...
var old_23857 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_23857))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_23857)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__21630__auto__ = (node === document.activeElement);
if(and__21630__auto__){
var and__21630__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__21630__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__23860 = jsprops;
(G__23860["defaultValue"] = value);

(G__23860["onChange"] = ((function (G__23860,v,value,on_change){
return (function (p1__23858_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__23858_SHARP_);
});})(G__23860,v,value,on_change))
);
...
var vec__23862 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23862,(0),null);
var id = cljs.core.nth.call(null,vec__23862,(1),null);
var class$ = cljs.core.nth.call(null,vec__23862,(2),null);
...
var temp__4659__auto__ = (function (){var G__23866 = cljs.core.meta.call(null,v);
if((G__23866 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__23866);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__23868_23869 = v;
var G__23868_23870__$1 = (((G__23868_23869 == null))?null:reagent.impl.template.key_from_vec.call(null,G__23868_23869));
if((G__23868_23870__$1 == null)){
} else {
(jsprops["key"] = G__23868_23870__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__23873 = cljs.core.meta.call(null,argv);
if((G__23873 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__23873);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__23874 = (((jsprops == null))?{}:jsprops);
(G__23874["key"] = key);
...
var G__23875 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__23875;
continue;
}
} else {
...
var n__22557__auto___23876 = a.length;
var i_23877 = (0);
while(true){
if((i_23877 < n__22557__auto___23876)){
(a[i_23877] = reagent.impl.template.as_element.call(null,(a[i_23877])));
...
var a = cljs.core.into_array.call(null,s);
var n__22557__auto___23879 = a.length;
var i_23880 = (0);
while(true){
if((i_23880 < n__22557__auto___23879)){
var val_23881 = (a[i_23880]);
if((cljs.core.vector_QMARK_.call(null,val_23881)) && ((reagent.impl.template.key_from_vec.call(null,val_23881) == null))){
(o["no-key"] = true);
} else {
}

(a[i_23880] = reagent.impl.template.as_element.call(null,val_23881));
...
if(cljs.core.truth_((function (){var and__21630__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__21630__auto__){
return (ctx["no-key"]);
} else {
return and__21630__auto__;
...
var G__23884 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23884) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__23884){
...
//# sourceMappingURL=template.js.map?rel=1467991926501