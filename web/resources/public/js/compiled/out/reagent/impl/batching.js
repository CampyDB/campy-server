...
var or__21642__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__21642__auto__)){
return or__21642__auto__;
} else {
var or__21642__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__21642__auto____$1)){
return or__21642__auto____$1;
} else {
var or__21642__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__21642__auto____$2)){
return or__21642__auto____$2;
} else {
var or__21642__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__21642__auto____$3)){
return or__21642__auto____$3;
} else {
...
var n__22557__auto__ = a.length;
var i = (0);
while(true){
if((i < n__22557__auto__)){
var c_23789 = (a[i]);
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__22248__auto__,writer__22249__auto__,opt__22250__auto__){
return cljs.core._write.call(null,writer__22249__auto__,"reagent.impl.batching/RenderQueue");
});
...
if((G__23793__$1 == null)){
return null;
} else {
return (G__23793__$1["argv"]);
}
});
...
if((G__23795_23796 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__23795_23796);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1467991926201